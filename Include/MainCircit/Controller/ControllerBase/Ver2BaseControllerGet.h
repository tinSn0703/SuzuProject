...
public:
	...
	ControllerGet(Bit24ControllerBase * _object);
...
{
	return ((_controller_data->_data._all_data >> _bit) & _and);
}
...
{
	return _controller_data->_data._command._stick_right_x;
}
...
{
	return _controller_data->_data._command._stick_right_y;
}
...
{
	return _controller_data->_data._command._stick_left_x;
}
...
{
	return _controller_data->_data._command._stick_left_y;
}
...
{
	return _controller_data->_data._command._cross_x;
}
...
{
	return _controller_data->_data._command._cross_y;
}
...
{
	return _controller_data->_data._all_data;
}
