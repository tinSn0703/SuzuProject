...
#include <MainCircit/Controller/Bit28Controller.h>
...
Bit28Controller::Bit28Controller(const UartNum _num_uart)

	: ControllerRewrite(NO)
	, _mem_uart(_num_uart)
{
...
void Bit28Controller::Allot(const UartData8bit _data[NUM_CONTROLLER_28BIT])
{
...
void Bit28Controller::Read(Uart::ModeReceive &_uart)
{
